$(document).ready(function() {
    ...
    $('.slider').slick({
        ...
        slidesToScroll: 1,
        adaptiveHeight: true,
        prevArrow: '<button type="button" class="slick-prev"><svg width="71px" height="72px" viewBox="0 0 71 72" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Group"><g><rect id="Rectangle-4" stroke="#FFFFFF" transform="translate(35.390873, 36.000000) rotate(-45.000000) translate(-35.390873, -36.000000) " x="10.890873" y="11.5" width="49" height="49"></rect><g id="right-arrow-copy-2" transform="translate(34.890873, 36.500000) rotate(-180.000000) translate(-34.890873, -36.500000) translate(21.390873, 29.000000)" fill="#FFFFFF" fill-rule="nonzero"><polygon id="Shape" points="19.5626038 0.0286259542 18.3619245 1.24311069 23.7049245 6.64734733 0 6.64734733 0 8.36490458 23.7049245 8.36490458 18.3619245 13.769084 19.5626038 14.9835687 26.9554528 7.5060687"></polygon></g></g></g></g></svg></button>',
        nextArrow: '<button type="button" class="slick-next"><svg width="71px" height="72px" viewBox="0 0 71 72" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Group"><g><rect id="Rectangle-4" stroke="#FFFFFF" transform="translate(35.390873, 36.000000) rotate(-45.000000) translate(-35.390873, -36.000000) " x="10.890873" y="11.5" width="49" height="49"></rect><g id="right-arrow-copy-2" transform="translate(34.890873, 36.500000) rotate(-180.000000) translate(-34.890873, -36.500000) translate(21.390873, 29.000000)" fill="#FFFFFF" fill-rule="nonzero"><polygon id="Shape" points="19.5626038 0.0286259542 18.3619245 1.24311069 23.7049245 6.64734733 0 6.64734733 0 8.36490458 23.7049245 8.36490458 18.3619245 13.769084 19.5626038 14.9835687 26.9554528 7.5060687"></polygon></g></g></g></g></svg></button>',
        dots: true,
        responsive: [
            {
                breakpoint: 1169,
    ...
    $('.plan').each(function() {
        ...
        $(window).on('load resize', function() {
            ...
            if (curHeight < 570) {
                curHeight = 570;
                curWidth = curHeight / (planHeightSrc / planWidthSrc);
            }
        ...
        $('body').on('mouseout', '.plan-scheme path', function(e) {
            if ($('.plan').width() > 1169) {
                window.clearTimeout(planTimer);
                planTimer = null;
        ...
        $('.plan-scheme path').click(function(e) {
            if ($('.plan').width() < 1170) {
                var curArea = $(this);
                var curIndex = $('.plan-scheme path').index(curArea);
        ...
        $('body').on('click', '.plan-window-close', function(e) {
            $('.plan-scheme path').removeClass('hover');
            $('.plan-window').css({'display': 'none'});
            e.preventDefault();
        });
            ...
            $('.plan-bg').draggable({
                ...
                drag: function(event, ui) {
                    if (ui.position.left >= 0) {
                        ...
                        if ($('.plan-bg').width() + ui.position.left <= $('.plan').width()) {
                            ui.position.left = $('.plan').width() - $('.plan-bg').width();
                        }
                    }
                }
            });
